...
8. ВЫЗОВИ Linker — добавит внешние кросс-ссылки и выполнит /lint
...
8. ВЫЗОВИ Linker — добавит перекрёстные ссылки и вызовет /lint
```
...
- **После Batch** — сразу обнови индексы (Linker добавит кросс-ссылки и вызовет /lint)
