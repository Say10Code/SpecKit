...
- **Skills** (`.claude/skills/`): lint-wiki, ingest, review, format-html, roadmap-status, spec-download
...
- 8 sub-agents, 6 skills
- `Specifications/`: 65 файлов в 11 директориях
- `specs-extracted/`: 58 TXT (PyPDF2) + 16 MD+JSON (Docling: 11×3GPP + 5×ETSI)
